...
# medium s
medium_yellow = (255, 255, 63)
medium_green = (0, 191, 0)
...
# intense s
intense_red = (255, 48, 48)
intense_orange = (255, 160, 48)
intense_green = (63, 255, 63)
intense_cyan = (63, 255, 255)
intense_azure = (32, 160, 255)
intense_violet = (159, 63, 255)
intense_mauve = (207, 63, 255)
...
# in-game
player_atk = lightest_grey
enemy_atk = lightest_red
needs_target = intense_cyan
status_effect_applied = intense_green
descend = intense_violet

player_die = intense_red
enemy_die = intense_orange

invalid = yellow
impossible = grey
error = intense_red

welcome_text = intense_azure
health_recovered = green

bar_text = white
bar_filled = dark_green
bar_empty = darkest_brown

menu_title = medium_yellow
menu_text = white
